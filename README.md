...
4.	Собственные наработки моделей предсказаний используя технический анализ и инструмент от google TensorFlow на 10 летней истории Bitcoin позволили получить превосходные результаты на периоде известном нейронке и бесполезные для нового периода. Сравнить это можно с тем, как если бы мы учили нейронку переводу слов, с чем нейронка прекрасно справляется, т.е. переводить те же слова и выражения, которыми мы пользуемся сейчас для нее не проблема, но если бы буквы, слова, выражения менялись каждый день (энтропия) , нейронка не смогла бы в достаточной степени вероятности делать правильный перевод, так как меняются правила слишком быстро и не заметно для нейронки.
